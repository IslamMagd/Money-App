package com.example.moneyapp.ui.screens.errors
...
import com.example.moneyapp.ui.theme.boldBlackCenter28
import com.example.moneyapp.ui.commonUi.button.ClickedButton

@Composable
fun InternetError(navController: NavController,
...
private fun InternetErrorPreview() {
    InternetError(navController = NavController(LocalContext.current))
}